...
const navItems: { icon: typeof LayoutDashboard; label: string; view: ViewType; shortcut: string }[] = [
  { icon: Target, label: 'Task Gravity', view: 'tasks', shortcut: '1' },
  { icon: LayoutDashboard, label: 'Live Board', view: 'dashboard', shortcut: '2' },
  ...
  { icon: Compass, label: 'Explore', view: 'explore', shortcut: '9' },
